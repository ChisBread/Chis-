...
//棋盘赋值中间类型 b[][]
template <typename _board_t> class assign_tmp {
  public:
...
//棋盘赋值中间类型 b[]
template <typename _board_t> class array_tmp {
  public:
...
class bcell_t {
  ...
  public:
    template <typename _board_t> bcell_t &operator=(assign_tmp<_board_t> &a) {
